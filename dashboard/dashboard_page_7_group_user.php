...
try {
    ...
    echo "<script>";
    echo "location.href = '?option=group-user&success'";
    echo "</script>";
...
if(isset($_POST['btn-submit-edit']))
{
    ...
    $school_id = strip_tags($_POST['school_id_edit']);
...
<li ><a href="?option=group-user">ทะเบียนเจ้าหน้าที่</a></li>
            ...
            <div class="modal-content">
             ...
             <form  method="post" name="form_<?=$num_gen?>"id="form_<?=$num_gen?>">
              <input type="hidden" class="form-control"  name="user_group_id" value="<?=$rowGen->user_group_id?>" required/>
                  ...
                  <label for="exampleInputEmail1">โรงเรียน</label>                
                  <select   class="form-control select2" style="width: 100%;" name="school_id_edit" id="school_id_edit" required>
                    <?php
                    $qa8 = $sql_process->runQuery(
                    "SELECT
                  tbl_school.school_id,
                  ...
                  tbl_school.school_id ASC");
                                    ...
                                    if ($rowGen->school_id == $rowI->school_id)
                                    {
                                      echo "SELECTED";
                                    }

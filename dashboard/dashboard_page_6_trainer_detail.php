...
tbl_trainer_data.trainer_id = :trainer_type_id_param");
$stmt->execute(array(":trainer_type_id_param"=>$trainer_type_id_get));
    ...
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <!-- <button type="button" class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip"title="Collapse">
          ...
          <button type="button" onclick="window.location.href='?option=trainer-data-edit&etnr=<?=$trainer_type_id_get?>'" class="btn btn-warning" data-toggle="tooltip" title="แก้ไข">
        แก้ไข
        </button> 
      </div>
    </div>

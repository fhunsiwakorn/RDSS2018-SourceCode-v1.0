...
$trainer_firstnam_eng = strip_tags($_POST['trainer_firstnam_eng']);
$trainer_lastname_eng = strip_tags($_POST['trainer_lastname_eng']);
$trainer_card = strip_tags($_POST['trainer_card']);

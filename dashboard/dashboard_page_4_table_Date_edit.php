...
$table2="tbl_exam_schedule_trainer";
 ...
 isset($_POST['esd_date']) && isset($_POST['school_id']) && isset($_POST['school_id'])  && isset($_POST['btn-submit-add'])) {
...
$stmt = $qGeneral->runQuery("SELECT * FROM tbl_exam_schedule WHERE esd_id=:esd_id_param");
$stmt->execute(array(":esd_id_param"=>$esd_id_POST));
...
<section class="content-header">
  ...
  <li><a href="?option=permission-Date">กำหนดตารางสอบใบอนุญาตขับขี่</a></li>

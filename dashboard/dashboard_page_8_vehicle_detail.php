...
");
$stmt->execute(array(":vegicle_data_id_param"=>$vegicle_data_id_get));
...
<li ><a href="?option=vehicle-data">ทะเบียนยานพาหนะ</a></li>
    ...
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <!-- <button type="button" class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip"title="Collapse">
          ...
          <button type="button" onclick="window.location.href='?option=vehicle-data-edit&evgdt=<?=$vegicle_data_id_get?>'" class="btn btn-warning" data-toggle="tooltip" title="แก้ไข">
        แก้ไข
        </button> 
      </div>
    </div>

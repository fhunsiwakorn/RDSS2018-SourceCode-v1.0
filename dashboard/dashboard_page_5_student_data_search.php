...
tbl_school
WHERE
(tbl_student_data.school_id = tbl_school.school_id AND tbl_student_data.is_delete = '1' AND LOCATE('$q', tbl_student_data.student_firstname_th) > 0) OR
(tbl_student_data.school_id = tbl_school.school_id AND tbl_student_data.is_delete = '1' AND LOCATE('$q', tbl_student_data.student_lastname_th) > 0) OR
(tbl_student_data.school_id = tbl_school.school_id AND tbl_student_data.is_delete = '1' AND LOCATE('$q', tbl_student_data.student_ID_card) > 0)
ORDER BY

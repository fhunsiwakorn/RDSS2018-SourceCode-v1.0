...
try {
    ...
    echo "<script>";
    echo "location.href = '?option=doc-data&success'";
    echo "</script>";
}
...
<section class="content-header">
  ...
  <!-- <li ><a href="?option=doc-data">ข้อมูลตั้งต้น</a></li> -->
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <label for="exampleInputEmail1">ชื่อเอกสาร </label>
                ...
                <label>โรงเรียน</label> <label style="color:red;">*</label>
             <select class="form-control select2" style="width: 100%;" name="school_id_edit"  required>
             <?php
           $qa3 = $qGeneral->runQuery(
           "SELECT
           tbl_school.school_id,
           ...
           if ($rowGen->school_id== $rowC->school_id)
           {
             echo "SELECTED";
           }

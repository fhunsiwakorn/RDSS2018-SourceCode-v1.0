...
<section class="content-header">
  ...
  <li class="active">ทะเบียนยานพาหนะ</li>
  </ol>
</section>
<!-- Main content -->
<section class="content">
  ...
  <div class="box">
    <div class="box-header with-border">
      <h3 class="box-title">ทะเบียนยานพาหนะ</h3><br>
      <div class="box-tools pull-right">
      <div class="btn-group">
      <button type="button" class="btn btn-default" title="เพิ่มข้อมูล" onclick="window.location.href='?option=AddVehicleForm"> <img id="myImg"  src="../images/images_system/add-1-icon.png"  width="30" height="30" ></button>
...
<!-- <?php echo  sprintf("%02d", $num_gen); ?>.) -->
        ...
        <button type="button" class="btn btn-warning"onclick="window.location.href='?option=vehicle-detail&evgdt=<?=$rowGen->vegicle_data_id?>'" data-toggle="tooltip" title="รายละเอียดเพิ่มเติม">
        รายละเอียด
        <!-- <img id="myImg"  src="../images/images_system/info.png"   width="30" height="30" > -->
        </button>
        <button type="button" class="btn btn-warning"  onclick="window.location.href='?option=vehicle-data-edit&evgdt=<?=$rowGen->vegicle_data_id?>'" >
        แก้ไข

...
tbl_school
WHERE
(tbl_trainer_data.school_id = tbl_school.school_id AND tbl_trainer_data.is_delete = '1' AND LOCATE('$q', tbl_trainer_data.trainer_firstname_th) > 0) OR
(tbl_trainer_data.school_id = tbl_school.school_id AND tbl_trainer_data.is_delete = '1' AND LOCATE('$q', tbl_trainer_data.trainer_lastname_th) > 0) OR
(tbl_trainer_data.school_id = tbl_school.school_id AND tbl_trainer_data.is_delete = '1' AND LOCATE('$q', tbl_trainer_data.trainer_card) > 0)
ORDER BY

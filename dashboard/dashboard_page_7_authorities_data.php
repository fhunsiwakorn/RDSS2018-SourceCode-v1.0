...
if(isset($_POST['btn-submit-add']))
{
  ...
  $user_list->register_user($user_name,$user_password,$user_prefix,$user_firstname,$user_lastname,$user_email,$school_id,$branch_id,$user_group_id,$user_crt,$user_flag,$user_status);
    ...
    echo "<script>";
    echo "location.href = '?option=authorities-data&success'";
    echo "</script>";
  }
}
...
<section class="content-header">
  ...
  <li class="active">เจ้าหน้าที่ดูแลระบบ</li>
  </ol>
</section>
<!-- Main content -->
<section class="content">
  ...
  <div class="box">
    <div class="box-header with-border">
      <h3 class="box-title">เจ้าหน้าที่ดูแลระบบ</h3><br>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">เจ้าหน้าที่ดูแลระบบ</h4>
              </div>
...
<span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
 ...
 <!-- <?php echo  sprintf("%02d", $num_gen); ?>.) -->
        ...
        <button type="button" class="btn btn-warning"  onclick="window.location.href='?option=authorities-edit&auttid=<?=$rowGen->user_id?>'" >
        แก้ไข

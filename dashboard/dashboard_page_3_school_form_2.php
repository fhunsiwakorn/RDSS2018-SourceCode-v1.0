...
$stmt = $sql_process->runQuery("SELECT * FROM tbl_school WHERE data_gen_id=:data_gen_id_param");
...
<section class="content-header">
  ...
  <li><a href="?option=school-edit&edc=<?=$dataRow['school_id']?>">ขั้นตอนที่ 1 แบบฟอร์มเพิ่มโรงเรียน</a></li>
...
<div class="box box-default">
            ...
            <div class="box-body">
            <button type="button" onclick="window.location.href='?option=school-form-step-2&data_gen=<?=$_GET["data_gen"]?>&get_data'" class="btn btn-success" data-toggle="tooltip" title="ใช้ข้อมูลเดียวกันกับโรงเรียน">

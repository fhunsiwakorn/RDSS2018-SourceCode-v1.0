...
if($_SESSION['user_status']!='2' && $_SESSION['user_status']!='3'){
  ...
  ///ตรวจสอบรหัสโค้ดว่ามีการบันทึกการสมัครหรือไม่
  if(isset($_GET['sccode']) && !empty($_GET['sccode'])) {
    $rst_temp_code=$_GET['sccode'];
    $total_data =$qGeneral->rowsQuery("SELECT tbl_register_temp.rst_temp_id FROM tbl_register_temp WHERE tbl_register_temp.rst_temp_code ='$rst_temp_code'");
    if($total_data<=0){
...
<link rel="stylesheet" href="../plugins/Animated_Buttons.css">

<script type="text/javascript" src="../plugins/auto_refresh/jquery.min.js"></script>
<!-- ตัดคำ -->
<style type="text/css"> 
.cutword
{
...
<body class="hold-transition skin-yellow-light sidebar-mini" style="font-size:12px;">
<!-- Site wrapper -->
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="?option=main" class="logo">
      ...
      <img src='<?=$pathschoolimg?>' style="width:150px; height:45px">
  ...
  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      <b>
      <?=$name_system?>  <?=$version?> <br>
      Copyright &copy; 2017 
      </b>
    </div>
    <strong>
    <!-- Copyright &copy; 2017  -->
    <a href="http://www.iddriver.com" target="_blank">

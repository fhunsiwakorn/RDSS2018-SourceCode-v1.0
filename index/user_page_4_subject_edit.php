...
$stmt = $qGeneral->runQuery("SELECT * FROM tbl_subject_data WHERE subject_data_id=:subject_data_id_param AND school_id=:school_id_param");
$stmt->execute(array(":subject_data_id_param"=>$subject_data_id_get,":school_id_param"=>$school_id));
...
<section class="content-header">
  ...
  <li><a href="?option=BOA3OEGXK80VDL4">ข้อมูลรายวิชา</a></li>

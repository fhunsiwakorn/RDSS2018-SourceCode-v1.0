...
try {
    ...
    echo "<script>";
    echo "location.href = '?option=B4EWPVIIVWB0FVY&success'";
    echo "</script>";
} 
...
<section class="content-header">
  <h1>
  ข้อมูลสาขา
    <small>จัดการข้อมูลข้อมูลสาขา</small>
  </h1>
  <ol class="breadcrumb">
...
tbl_branch.crt_by = tbl_user.user_id AND
...
<!-- <?php echo  sprintf("%02d", $num_gen); ?>.) -->
        ...
        <button type="button" class="btn btn-warning"  onclick="window.location.href='?option=edit-branch&ebra=<?=$rowGen->branch_id?>'" >
        แก้ไข

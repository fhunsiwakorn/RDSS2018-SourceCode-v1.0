...
$sql_process->fastQuery("UPDATE  tbl_register_temp SET transportation_id='$transportation_id' WHERE rst_temp_code='$rst_temp_code'");
...
$type_study_id=$dataRowA['type_study_id'];
      ...
      // $sql_process->add_date_exam_schedule($esd_id,$type_study_id,$school_id,$rst_temp_code);
...
if(isset($_POST['esd_idx']) && isset($_POST['btn-submit'])) {
  ...
  $type_study_idx=$dataRowB['type_study_id'];
        ...
        // $sql_process->add_date_exam_schedule($esd_idx,$type_study_idx,$school_id,$rst_temp_code);
...
$year_search1 = isset($_POST['year_search1']) ? $_POST['year_search1'] : date("Y");
$month_search1 = isset($_POST['month_search1']) ? $_POST['month_search1'] : date("m");   
$year_search2 = isset($_POST['year_search2']) ? $_POST['year_search2'] : date("Y");
$month_search2 = isset($_POST['month_search2']) ? $_POST['month_search2'] : date("m");    

$esd_id_a = isset($_POST['esd_id'][0]) ? $_POST['esd_id'][0] : NULL; 
$esd_id_b = isset($_POST['esd_idx'][0]) ? $_POST['esd_idx'][0] : NULL; 
?>
...
<?=$num_gen?>
        ...
        <div class="radio">
            <label style="font-size: 1.5em">
                <input type="radio" name="esd_id[]" id="esd_id<?=$num_gen?>" <?php if($esd_id_a ==$rowGen->esd_id){ echo "checked";} ?> value="<?=$rowGen->esd_id?>">
...
<?=$num_genx?>
        ...
        <div class="radio">
            <label style="font-size: 1.5em">
                <input type="radio" name="esd_idx[]" id="esd_idx<?=$num_genx?>"  <?php if($esd_id_b ==$rowGenx->esd_id){ echo "checked";} ?> value="<?=$rowGenx->esd_id?>">
                <span class="cr"><i class="cr-icon fa fa-circle"></i></span>
...
if ($school_province_id == $rowGen->province_id)
{
  echo "SELECTED";
}

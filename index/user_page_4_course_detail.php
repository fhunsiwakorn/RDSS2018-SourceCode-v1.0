...
tbl_school
WHERE
tbl_course_data.course_data_id = :course_id_param AND
...
");
$stmt->execute(array(":course_id_param"=>$course_data_id_get));
$dataRow=$stmt->fetch(PDO::FETCH_ASSOC);
$school_id_get=$dataRow['school_id'];
    ...
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <!-- <button type="button" class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip"title="Collapse">
          ...
          <button type="button" OnClick="move()"  <?php if($school_id_get==0){ echo "disabled";}?> class="btn btn-danger" data-toggle="tooltip" title="ลบวิชาเรียนในหลักสูตร ระบบจะทำการรีเซตหลักสูตรใหม่ และดำเนินการกำหนดรายวิชาใหม่อีกครั้ง">
          ลบวิชาเรียนในหลักสูตร
           ...
           <script>
                        function move() {
                          swal({
                            title: "ยืนยันการลบวิชาเรียนในหลักสูตร <?=$dataRow["course_data_name"]?>",
                            text: "",
                            type: "warning",
...
tbl_subject_in_course.school_id=:school_id_param
ORDER BY
tbl_subject_in_course.subject_in_course_id ASC

");

$qg->execute(array(":course_data_id_param"=>$course_data_id_get,":school_id_param"=>$school_id_get));

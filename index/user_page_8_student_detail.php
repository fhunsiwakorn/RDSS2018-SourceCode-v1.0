...
tbl_student_data.student_code = :student_code_param");
    ...
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <!-- <button type="button" class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip"title="Collapse">
          ...
          <button type="button" onclick="window.location.href='?option=student-data-edit&estu=<?=$student_code_get?>'" class="btn btn-warning" data-toggle="tooltip" title="แก้ไข">
        แก้ไข
        </button> 
      </div>
    </div>

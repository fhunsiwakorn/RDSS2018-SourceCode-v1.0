...
//   $school_id = strip_tags($_POST['school_id']);
  ...
  echo "<script>";
   echo "location.href = '?option=BOA3OEGXK80VDL4&success'";
   echo "</script>";
}
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <div class="col-xs-6">
                ...
                <input type="hidden" class="form-control" name="type_subject_id" id="type_subject_id" value="2" />
                <!-- <div class="col-xs-6">
                ...
                <div class="col-xs-6">
                  ...
                  <input autocomplete="off" maxlength="2" type="number" class="form-control" name="force_hour" id="force_hour" required >
                </div>
...
<option value="S" <?php if($search_school =="S" || $search_school==$school_id){ echo "SELECTED";} ?>>-- วิชาของโรงเรียน --</option>
...
<div class="checkbox">
<label style="font-size: 1em">
<input type="checkbox"  name="DELsubject_data_id[]" id="pNUM"  value="<?=$rowGen->subject_data_id?>" <?php if($rowGen->school_id==0){ echo "disabled";}?>>
<span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>
</label> 
<!-- <?php echo  sprintf("%02d", $num_gen); ?>.) -->
        ...
        <button type="button" class="btn btn-warning" <?php if($rowGen->school_id==0){ echo "disabled";}?> onclick="window.location.href='?option=subject-data-edit&sue=<?=$rowGen->subject_data_id?>'" >

<?php   
$table="tbl_register_temp_student";
...
$student_firstnam_eng = isset($_POST['student_firstnam_eng']) ? $_POST['student_firstnam_eng'] : false; 
$student_lastname_eng = isset($_POST['student_lastname_eng']) ? $_POST['student_lastname_eng'] : false; 
$student_ID_card = strip_tags($_POST['student_ID_card']);
$student_Passport = isset($_POST['student_Passport']) ? $_POST['student_Passport'] : false; 

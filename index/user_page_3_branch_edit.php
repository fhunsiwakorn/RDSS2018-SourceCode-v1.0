...
if(isset($_POST['btn-submit-edit']))
{
  ...
  try {
    ...
    echo "<script>";
    echo "location.href = '?option=edit-branch&ebra=$branch_id&success'";
    echo "</script>";
}
...
$stmt = $qGeneral->runQuery("SELECT * FROM tbl_branch WHERE branch_id=:branch_id_param");
...
<li><a href="?option=B4EWPVIIVWB0FVY"><i class="fa fa-dashboard"></i> ข้อมูลสาขา</a></li>

...
{   
  ...
  try {
    ...
    // echo "<script>";
    // echo "location.href = '?option=school-edit&edc=$school_id&success'";
    // echo "</script>";
    echo "<script>";
    echo "location.href = '?option=edit-sc-form-2&data_gen=$data_gen_id&success'";
    echo "</script>";
    // GO >>user_page_3_school_edit_form_2.php
}
...
<section class="content-header">
  ...
  <li class="active">ขั้นตอนที่ 1 แบบฟอร์มโรงเรียน</li>
  </ol>
</section>
<!-- Main content -->

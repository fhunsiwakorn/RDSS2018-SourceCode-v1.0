...
require_once('user_page_8_student_form_logChk.php');
if(isset($_GET['success'])){
    echo "<script>";
    echo 'swal("ทำรายการสำเร็จ !", "ปิดหน้าต่างนี้ !", "success")';
    echo "</script>";
}
$student_code_get = $_GET['estu'];	
$stmt = $sql_process->runQuery("SELECT * FROM tbl_student_data WHERE student_code=:student_code_param");
$stmt->execute(array(":student_code_param"=>$student_code_get));
...
<section class="content-header">
  ...
  <li><a href="?option=MZI4NFZ0038F41I">ทะเบียนนักเรียน</a></li>
...
<input type="hidden" name="student_id" value="<?=$dataRow['student_id']?>"/>

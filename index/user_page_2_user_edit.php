...
echo "<script>";
echo "location.href = '?option=user-edit&auttid=$user_id&success'";
echo "</script>";
  }
}
...
<section class="content-header">
  ...
  <!-- <li ><a href="?option=authorities-data-general">เจ้าหน้าที่ทั่วไป</a></li> -->
...
echo"<option value='$rowI->branch_id'";
if ($dataRow['branch_id'] == $rowI->branch_id)
{
  echo "SELECTED";
}
echo ">$rowI->branch_name</option>\n";
}
?>             
</select>
</div>   
...
if ($dataRow['user_group_id'] == $rowJ->user_group_id)
{
  echo "SELECTED";
}

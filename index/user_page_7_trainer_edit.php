<?php
require_once('user_page_7_trainer_form_logChk.php');
...
$stmt = $qGeneral->runQuery("SELECT * FROM tbl_trainer_data WHERE trainer_code=:trainer_code_param");
...
<input type="hidden" name="trainer_id" value="<?=$dataRow['trainer_id']?>"/>
...
<input type="text" class="form-control" value="<?=$dataRow['trainer_code_motorcycle']?>"  name="trainer_code_motorcycle" id="trainer_code_motorcycle"  placeholder="รหัสครูฝึกประเภทจักรยานยนต์">
</div>

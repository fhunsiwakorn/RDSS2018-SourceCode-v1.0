<?php  
   ...
   header("Cache-Control: post-check=0, pre-check=0", false);      
    ...
    $stm= $qGeneral->runQuery("SELECT   $find_field ,$find_id FROM $table_db WHERE tbl_location_zipcode.is_delete ='1' AND LOCATE('$q', $find_field) > 0 

<?php  
   ...
   header("Cache-Control: post-check=0, pre-check=0", false);      
    ...
    $pagesize = 50; 
    $table_db="tbl_location_amphur";
    $find_id="amphur_id";  
    $find_field="amphur_name"; 
    ...
    $stm= $qGeneral->runQuery("SELECT $find_id,$find_field FROM $table_db WHERE tbl_location_amphur.is_delete ='1'AND LOCATE('$q', $find_field) > 0 
